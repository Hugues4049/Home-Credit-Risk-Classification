...
def model_run(algorithm, dtrain_X, dtrain_Y, dtest_X, dtest_Y, cols=None):
    ...
    name = './Home-Credit-Risk-Classification/predictions/predictions-from-{}.csv'.format(algorithm)
...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        rfc = RandomForestClassifier(n_estimators=n_estimators_rfc, max_depth = max_depth_rfc, random_state=0)
        ...
        # 
        classifier_names = ['Logistic Regression', 'Random Forest', 'Decision Tree', 'XGBoost', 'Gradient Boosting']
        accuracy_scores = [accuracy_logit, accuracy_rfc, accuracy_dtc, accuracy_xgb, accuracy_gbc] 
        f1_scores = [f1_logit, f1_rfc, f1_dtc,  f1_xgb, f1_gbc]
        auc_scores = [auc_score_logit, auc_score_rfc, auc_score_dtc,  auc_score_xgb, auc_score_gbc]
        classify_metrics = [classify_metrics_logit, classify_metrics_rfc, classify_metrics_dtc, classify_metrics_xgb, classify_metrics_gbc]
